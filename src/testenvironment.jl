...
Base.:(==)(a::TestEnvironment, b::TestEnvironment) = a.project_uri == b.project_uri && a.package_uri == b.package_uri && a.package_name == b.package_name && a.juliaCmd == b.juliaCmd && a.juliaArgs == b.juliaArgs && isequal(a.juliaNumThreads, b.juliaNumThreads) && a.mode == b.mode && a.env == b.env
